 ...
 */
public class HotContAdapter extends BaseQuickAdapter<CategoryContsBean.ContListBean, BaseViewHolder> {
    public HotContAdapter(int layoutResId, @Nullable List<CategoryContsBean.ContListBean> data) {
