...
public class LoginBean {
    ...
    public static class UserInfoBean {
         ...
         * lastLoginTime : 2019-07-27T09:47:51
         * level : 0
         * mail : null
         * mainId : null
         * mainStatus : null
        ...
        public String toString() {
            return "UserInfoBean{" +
                    ...
                    ", appType=" + appType +
                    ", area=" + area +
                    ", biankeType=" + biankeType +
                    ", birthday=" + birthday +
                    ", forbidSetHead=" + forbidSetHead +
                    ", id=" + id +
                    ", illegalHeadTimes=" + illegalHeadTimes +
                    ", interestJson=" + interestJson +
                    ", isAuth=" + isAuth +
                    ", isAuthor=" + isAuthor +
                    ", isBianke=" + isBianke +
                    ", isBiankeAgreement=" + isBiankeAgreement +
                    ", isBlackList=" + isBlackList +
                    ", isIllegalHead=" + isIllegalHead +
                    ", isPaike=" + isPaike +
                    ", isPaikeAgreement=" + isPaikeAgreement +
                    ", isSetInterest=" + isSetInterest +
                    ", isSetPwd=" + isSetPwd +
                    ...
                    ", sex=" + sex +
                    ", signature='" + signature + '\'' +
                    ", societyIdMap=" + societyIdMap +
                    ", token='" + token + '\'' +
                    ", userId=" + userId +
                    ", userType='" + userType + '\'' +
                    ", youngModeEnable=" + youngModeEnable +
                    ", zenId=" + zenId +
                    ", images=" + images +
                    '}';
        }
